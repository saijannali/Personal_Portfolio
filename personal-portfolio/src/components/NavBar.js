...
import logo from '../assets/img/indiana-logo.svg';
        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#tech" className={activeLink === 'tech' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('tech')}>Tech</Nav.Link>
